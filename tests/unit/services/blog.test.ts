...
const mockBlogPosts = [
  {
    ...
    cover_image: 'https://res.cloudinary.com/practicaldev/image/fetch/s--pfm-ctOu--/c_imagga_scale,f_auto,fl_progressive,h_420,q_auto,w_1000/https://dev-to-uploads.s3.amazonaws.com/uploads/articles/3edpm5mnelsshp9h64dz.jpg',
    ...
    user: {
      ...
      user_id: 1023909,
      website_url: null,
      profile_image: 'https://res.cloudinary.com/practicaldev/image/fetch/s--aghmJdku--/c_fill,f_auto,fl_progressive,h_640,q_auto,w_640/https://dev-to-uploads.s3.amazonaws.com/uploads/user/profile_image/1023909/cb8b60bf-80e4-4c84-a573-b81b8282055d.png',
      profile_image_90: 'https://res.cloudinary.com/practicaldev/image/fetch/s--UuYCbUQk--/c_fill,f_auto,fl_progressive,h_90,q_auto,w_90/https://dev-to-uploads.s3.amazonaws.com/uploads/user/profile_image/1023909/cb8b60bf-80e4-4c84-a573-b81b8282055d.png'
    }
  },
  {
    type_of: 'article',
...
describe('Dev.to Service', () => {
  ...
  describe('getBlogPosts', () => {
    it('should return an array of blog posts', async () => {
      ...
      expect(blogPosts[0].positive_reactions_count).toEqual(mockBlogPosts[0].positive_reactions_count);
      ...
      expect(blogPosts[1].positive_reactions_count).toEqual(mockBlogPosts[1].positive_reactions_count);
