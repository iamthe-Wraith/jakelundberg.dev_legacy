<script lang="ts">
	...
	function onEnhancedSubmitResponse(
...
<div class="get-in-touch">
	...
	>
		<Input
			...
			error={formData?.email.touched && !formData?.email.value
		...
		<Input
			...
			error={formData?.subject.touched && !formData?.subject.value
		...
		<TextArea
			...
			error={formData?.message.touched && !formData?.message.value
		...
		<div class="buttons-container">
			<Button type="submit" disabled={isOkayToSend}>Send</Button>
		</div>
	</form>
</div>
