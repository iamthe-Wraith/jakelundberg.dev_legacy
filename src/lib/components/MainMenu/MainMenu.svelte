...
{#if $mainMenu.isOpen}
	<Dialog open={$mainMenu.isOpen} class="dialog" static>
		<div class="main-menu-overlay" transition:fade={{ duration: animationDuration }}>
			<DialogOverlay style={overlayStyles} />
		</div>

		<div class="main-menu-container" transition:fly={{ y: -50, duration: animationDuration }}>
				...
				<div class="main-menu">
                  ...
                  <Details title="Secrets Found">
					...
					<div class="main-menu-close-btn">
						<Close id="main-menu-close-btn" on:click={() => mainMenu.close()} />
					</div>
				</div>
			</HandDrawnContainer>
		</div>
...
<style lang="scss">
   ...
   */
	...
	*
		:global(
			.main-menu-options button.main-menu-option-selected .main-menu-rough-engageable-option
		) {
		opacity: 1;
	}
	...
	*
		:global(
			.main-menu-options
				button:not(.main-menu-option-selected):hover
				.main-menu-rough-engageable-option-dt
		),
	*
		:global(
			.main-menu-options
				button:not(.main-menu-option-selected):focus
				.main-menu-rough-engageable-option-dt
		),
	*
		:global(
			.main-menu-options button.main-menu-option-selected .main-menu-rough-engageable-option-dt
		) {
		right: 0;
		opacity: 1;
	}
