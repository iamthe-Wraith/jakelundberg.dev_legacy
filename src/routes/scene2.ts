...
export class WraithScene2 extends WraithScene {
  public name = 's2-anchor';
  public position = {
    active: new THREE.Vector3(0, 0, 25),
    inactive: new THREE.Vector3(0, -10, 25),
  };
  ...
  constructor(assets: Record<AssetNames, (THREE.Mesh | THREE.Group | null)>) {
    ...
    if (assets['stepstone-1']) {
      ...
      stepStone1_3.name = 's2-stepstone1-3';
    ...
    if (assets['stepstone-3']) {
      ...
      stepStone3_1.name = 's2-stepstone3-1';
      ...
      stepStone3_2.name = 's2-stepstone3-2';
    ...
    if (assets['stepstone-4']) {
      ...
      stepStone4_1.name = 's2-stepstone4-1';
      ...
      stepStone4_2.name = 's2-stepstone4-2';
      ...
      stepStone4_3.name = 's2-stepstone4-3';
    ...
    if (assets['stepstone-5']) {
      ...
      stepStone5_1.name = 's2-stepstone5-1';
      ...
      stepStone5_2.name = 's2-stepstone5-1';
  ...
  protected isLoaded = () => {
    this.loaded = this.loaded || !!this.anchor.getObjectByName('s2-tree4_2');
    return this.loaded;
  };
}